...
class ReservationCubit extends Cubit<ReservationFormnState> {
  ...
  void quotesChanged(String value) {
    ...
    emit(state.copyWith(
      quotes: quotes,
      status: Formz.validate([state.dateCheckIn, state.dateCheckOut, quotes]),
    ));
  }
  ...
  void dateCheckInChanged(DateTime value) {
    ...
    emit(state.copyWith(
      ...
      status: Formz.validate([dateCheckIn, state.dateCheckOut, state.quotes]),
    ));
  }
  ...
  void dateCheckOutChanged(DateTime value) {
    ...
    emit(state.copyWith(
      ...
      status: Formz.validate([state.dateCheckIn, dateCheckOut, state.quotes]),
    ));
  }
